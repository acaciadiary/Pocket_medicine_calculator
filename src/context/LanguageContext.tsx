...
const translations: Record<Language, Translations> = {
  zh: {
    ...
    'common.copy': '複製臨床紀錄',
    'common.copied': '已複製！',
    'common.ehr_copy': '複製病歷範本 (EHR Copy)',
    'common.ehr_copied': '範本已複製！',
    'common.smart_link.diuretic': '偵測到利尿劑使用？建議點此切換至 FEUrea (尿素排泄分數) 以免鈉排泄偏高失真。',
    'common.smart_link.hagma': '偵測到高陰離子間隙代謝性酸中毒 (HAGMA)。建議點此使用 Winter\'s 公式評估呼吸代償。',
    'common.reset': '重設',
  ...
  en: {
    ...
    'common.ehr_copy': 'EHR Copy',
    'common.ehr_copied': 'EHR Copied!',
    'common.smart_link.diuretic': 'Patient on active diuretics? Click here to switch to FEUrea (Fractional Excretion of Urea) for accurate triage.',
    'common.smart_link.hagma': 'High Anion Gap (HAGMA) detected. Click here to evaluate respiratory compensation using Winter\'s Formula.',
    'common.reset': 'Reset',
